  ...
  <a href="http://gokercebeci.com/dev/f4player" title="flv player">flv player</a>
	...
	<!--<embed width="100%" height="100%" name="plugin" src="http://d.uzmimg.com/assets/web/1.0.1/uplayer/Player.swf?id=0.8465365362338729" type="application/x-shockwave-flash">    -->    
		...
		<div id="related_topics">
			<div id="related_topics_title">
				<div id="related_topics_title_image">
					<img src="img/eksperts/4.png" />
				</div>
			Oftalmoloq <br>
			<span> Aytən Xudiyeva </span>
			</div>
			<div id="related_topics_list">
			<span>Digər videolar:<span> <br>
			<ul> 
				<li>1. Göz ağrısı necə müalicə olunur?</li>
				<li>2. Gözdə yad cisim hissi nədən qaynaqlanır?</li>
				<li>3. Göz ağrısı ilə bağlı həkimə getmək vacibdirmi?</li>
				<li>4. Gözə toz düşəndə nə edilməlidir?</li>
				<li>5. Göz ağrısı psixoloji səbəblərdən ola bilərmi?</li>
				<li>6. Linza gözə batdıqda nə etmək lazımdır?</li>
			</ul>	
			</div>
	...
	<div id="opened_video_text_related_videos_div">
		<div id="opened_video_title_text">
			...
			Gözlərin ağrıma səbəbləri müxtəlifdir.Əgər gözdə iltihabi proses olrsa,göz və baş ağrısı baş verir.
			Bunun nəticəsində də gözdə sulanma olur.Ancaq göz ağrısı daha tez-tez rast gəlinən əlamətdir ki, zədələnmələr nəticəsində baş verir.
			</div>
